...
public class WheelView extends ScrollView {
   ...
   // public static final int TEXT_COLOR_FOCUS = 0XFF0288CE;      //选中色
    public static final int TEXT_COLOR_FOCUS = 0XFF614839;      //选中色
    public static final int TEXT_COLOR_NORMAL = 0XFFBBBBBB;
   // public static final int LINE_COLOR = 0XFF83CDE6;
    public static final int LINE_COLOR = 0XFF614839;
